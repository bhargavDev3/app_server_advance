...
import ctypes
import sys
from app_main import client_name, New_Build_Source, base_path, log_file
...
def clean_directory(client_path):
    ...
    for item in os.listdir(client_path):
        ...
        try:
            ...
            write_log(log_file, 3, "Copy_paste.py", client_name, 0, 1, [str(e)])  # Log failure
...
if __name__ == "__main__":
    ...
    if not is_admin():
        ...
        write_log(log_file, 3, "Copy_paste.py", client_name, 1, 0, [])  # Log success
